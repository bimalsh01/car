        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text(
                "1. How can I order items ? \n- You can order our Car by clicking in one of the items you want and in the details page you can add them to the cart and from cart you can order as many products as you want.",
                style: TextStyle(
                    color: Color.fromARGB(255, 13, 78, 35),
                    fontSize: 17,
                    fontWeight: FontWeight.bold),
